...
class ProgressButton @JvmOverloads constructor(
    ...
    init {
        ...
        if (!isInEditMode) {
            ...
            cornerRadius = a.getDimensionPixelOffset(R.styleable.ProgressButton_dview_pb_cornerRadius, cornerRadius)
            showBorder = a.getBoolean(R.styleable.ProgressButton_dview_pb_showBorder, showBorder)
            borderWidth = a.getDimensionPixelOffset(R.styleable.ProgressButton_dview_pb_borderWidth, borderWidth)
            borderColor = a.getColor(R.styleable.ProgressButton_dview_pb_borderColor, borderColor)
            hoverTextColor = a.getColor(R.styleable.ProgressButton_dview_pb_hoverTextColor, hoverTextColor)
            progressBackgroundColor = a.getColor(R.styleable.ProgressButton_dview_pb_backgroundColor, progressBackgroundColor)
            progressHoverColor = a.getColor(R.styleable.ProgressButton_dview_pb_hoverColor, progressHoverColor)
            pausedText = a.getString(R.styleable.ProgressButton_dview_pb_pausedText) ?: ""
            finishedText = a.getString(R.styleable.ProgressButton_dview_pb_finishedText) ?: ""
            autoReset = a.getBoolean(R.styleable.ProgressButton_dview_pb_autoReset, autoReset)
            a.recycle()
